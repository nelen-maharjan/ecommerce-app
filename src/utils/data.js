import { Home, LayoutList, List, Settings, SquareMenu, UsersRound } from "lucide-react";
...
export const sidebarRoutes = [
  ...
  },
  {
    ...
    icon: <SquareMenu className="h-5 w-5 text-gray-500" />,
  },
  {
    id: 4,
    title: "Products",
    route: "/dashboard/products",
    icon: <List className="h-5 w-5 text-gray-500" />,
  },
  {
    id: 5,
    title: "Categories",
    route: "/dashboard/categories",
    icon: <LayoutList className="h-5 w-5 text-gray-500" />,
  },
  {
    id: 6,
    title: "Settings",

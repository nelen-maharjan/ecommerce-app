...
const CartPage = () => {
  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-6 shadow-md my-8 ">
        <div className="w-full bg-white p-10">
          ...
          <div className="flex mt-10 mb-5">
            <h3 className="font-semibold text-center text-xs md:uppercase w-2/5">Product Details</h3>
            <h3 className="font-semibold text-center text-xs md:uppercase w-2/4">Quantity</h3>
            <h3 className="font-semibold text-center text-xs md:uppercase w-2/4">Price</h3>
            <h3 className="font-semibold text-center text-xs md:uppercase w-2/4">Total</h3>
          </div>
          {cart.map((item, index) => (
